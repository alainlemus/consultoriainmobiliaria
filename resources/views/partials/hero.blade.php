...
>
    ...
    <div class="relative z-20 px-4 py-32 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-44">
        <div class="max-w-3xl">
            <p class="mb-4 section-subtitle text-gold-400">Consultoría Inmobiliaria en Huejutla de Reyes, Hidalgo</p>
            {{-- Badge rojo ladrillo — resalta INFONAVIT/FOVISSSTE como servicio principal --}}
            <div
                class="inline-flex items-center gap-2 px-3 py-1 mb-5 text-xs font-semibold tracking-widest text-white uppercase bg-crimson-600">
            ...
            <h1 class="mb-6 font-serif text-5xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
            ...
            <p class="max-w-xl mb-2 text-lg leading-relaxed text-cream-200 sm:text-xl">
                Tramitamos tu crédito <strong class="text-gold-400">INFONAVIT</strong> o <strong
                    class="text-gold-400">FOVISSSTE</strong> en Hidalgo, Veracruz y San Luis Potosí. Avalúos, escrituras
                y gestoría inmobiliaria sin costo inicial.
            </p>
            <p class="mb-10 text-xl font-script text-gold-400">Confianza • Transparencia • Resultados</p>
            <div class="flex flex-col gap-4 sm:flex-row">
                <a href="https://wa.me/{{ setting('whatsapp_1', '527711910395') }}?text=Hola,%20quiero%20información"
            ...
            <p class="text-cream-300/50 text-xs mt-6 max-w-xl">
                Consultoría Inmobiliaria no forma parte de INFONAVIT ni de FOVISSSTE, ni los representa oficialmente.
                Somos una consultoría privada que orienta y acompaña a nuestros clientes en su trámite de crédito hipotecario.
            </p>
        </div>
    </div>
