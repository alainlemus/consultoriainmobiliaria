...
return [
    ...
    'attributes'             => [
        ...
        // ── CRM Inmobiliaria ──────────────────────────────────────────────
        'acreditado_nombre'          => 'nombre del acreditado',
        'acreditado_curp'            => 'CURP del acreditado',
        'acreditado_rfc'             => 'RFC del acreditado',
        'acreditado_telefono'        => 'teléfono del acreditado',
        'acreditado_email'           => 'correo del acreditado',
        'acreditado_fecha_nacimiento'=> 'fecha de nacimiento del acreditado',
        'acreditado_cp'              => 'código postal del acreditado',
        'acreditado_domicilio'       => 'domicilio del acreditado',
        'acreditado_colonia'         => 'colonia del acreditado',
        'acreditado_municipio'       => 'municipio del acreditado',
        'acreditado_estado'          => 'estado del acreditado',
        'acreditado_estado_civil'    => 'estado civil del acreditado',
        'acreditado_antiguedad_laboral' => 'antigüedad laboral',
        'acreditado_numero_credito'  => 'número de crédito',
        'vendedor_nombre'            => 'nombre del vendedor',
        'vendedor_curp'              => 'CURP del vendedor',
        'vendedor_rfc'               => 'RFC del vendedor',
        'vendedor_telefono'          => 'teléfono del vendedor',
        'vendedor_email'             => 'correo del vendedor',
        'vendedor_clabe'             => 'CLABE interbancaria',
        'vendedor_banco'             => 'banco del vendedor',
        'vivienda_cp'                => 'código postal de la vivienda',
        'monto_credito'              => 'monto del crédito',
        'subcuenta_vivienda'         => 'subcuenta de vivienda',
        'monto_total_estimado'       => 'monto total estimado',
        'honorarios_porcentaje'      => 'porcentaje de honorarios',
        'honorarios_monto'           => 'monto de honorarios',
        'fecha_apertura'             => 'fecha de apertura',
        'fecha_cierre'               => 'fecha de cierre',
        'fecha_pago_honorarios'      => 'fecha de cobro de honorarios',
        'porcentaje_honorarios'      => 'porcentaje de honorarios',
        'fecha_aprobacion'           => 'fecha de aprobación',
        'fecha_pago'                 => 'fecha de pago',
        'salario_mensual'            => 'salario mensual',
        'monto_credito_estimado'     => 'monto de crédito estimado',
        'tipo_tramite_id'            => 'tipo de trámite',
        'etapa_tramite_id'           => 'etapa del trámite',
