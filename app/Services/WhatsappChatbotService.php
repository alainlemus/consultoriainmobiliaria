...
class WhatsappChatbotService
{
    ...
    {
        // Pasos solo para servicios de crédito (INFONAVIT/FOVISSSTE)
        if (in_array($paso->clave, ['situacion_laboral', 'curp'])) {
    ...
    private function crearProspecto(WhatsappConversation $conv): void
    {
        ...
        foreach ($datos as $clave => $valor) {
            if (! in_array($clave, ['nombre', 'nombre_completo', 'servicio', 'servicio_clave',
                                     'correo', 'requiere_curp', 'telefono_confirmado']) && $valor) {
