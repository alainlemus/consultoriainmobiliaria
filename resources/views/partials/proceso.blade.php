    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="flex flex-col items-center text-center group">
                <div class="w-16 h-16 bg-white border-2 border-gold-400 rounded-full flex items-center justify-center mb-4 shadow-md group-hover:bg-gold-400 transition-all duration-300 z-10">
                    <span class="font-serif font-bold text-gold-500 text-lg group-hover:text-dark-900 transition-colors">{{ $paso->numero }}</span>
                </div>
